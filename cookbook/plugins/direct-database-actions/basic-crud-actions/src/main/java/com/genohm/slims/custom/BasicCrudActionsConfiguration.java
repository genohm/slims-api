 ...
 *
 * <p>Any property included will appear as a key in the YAML configuration, and when the plugin's routes are executed,
 * the corresponding value in the YAML will be used as the current value of that property.</p>
 *
